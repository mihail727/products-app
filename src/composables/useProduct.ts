...
function getInitialProducts(): IProduct[] {
	return [
		{
			name: 'Фотоаппарат',
			desc: 'Фотоаппарт минималистичной окраски с отличным качеством фото',
			price: 10000,
			imageLink: 'https://i.imgur.com/g6xw8wT.png',
		},
		{
			name: 'Фотоаппарат',
			desc: 'Довольно-таки интересное описание товара в несколько строк. Довольно-таки интересное описание товара в несколько строк Довольно-таки интересное описание товара в несколько строк. Довольно-таки интересное описание товара в несколько строк',
			price: 10000,
			imageLink: 'https://i.imgur.com/g6xw8wT.png',
		},
		{
